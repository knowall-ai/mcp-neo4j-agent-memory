...
. Check the proportions against REVERIE: new renders tend to come out slightly condensed, so scale the cut-out horizontally until its letters have the same extended width-to-height ratio as the REVERIE lettering (about 4.9 : 1 for seven letters). Leave the stroke weight as generated.
